...
/*
    ...
    Save hurufBiasa equals 'abcdefghijklmnopqrstuvwxyz'
    Save hurufH8B1 equals  '!@#$%^&*()-+1234567890[]{}'
    IF InputString equals hurufBiasa 
    Calculate hasil + hurufH8B1
    Display hasil
