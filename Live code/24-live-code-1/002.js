...
var name = 'Kel' // silakan berikan nilai bebas
...
if (name == ''){
    ...
    console.log ('Dapat Memesan Steak')
}
    else if (age >= 55) {
        var steak = 300000
        var diskon = 300000 * 0.7
        console.log('Dapat Memesan Steak dan mendapakan diskon 30%' )
    }
...
if (money <= steak) {
    console.log('Uang tidak cukup, Anda harus pulang !')
        ...
        var hasil = money - diskon
        console.log('Anda dapat memesan steak' + ' Sisa Kembalian anda adalah ' + hasil)
    }
